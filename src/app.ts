...
export class app {
  ...
  configureRouter(config: RouterConfiguration, router: Router): void {
    ...
    config.map([
      ...
      {route:["order/mf-active-orders"], name: 'order/active-orders', moduleId: PLATFORM.moduleName('pages/order/mf-active-orders/mf-active-orders'), nav: true, title: 'Active orders'}
    ]);
